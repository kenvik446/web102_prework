...
const message = `We have raised a total of $${totalRaised.toLocaleString()} for ${totalGames} ${totalGames === 1 ? 'game' : 'games'}. Currently, ${unfundedGames} ${unfundedGames === 1 ? 'game remains' : 'games remain'} unfunded. Let's help bring all these projects to life!`;
...
// Check the first words of each game
console.log("Secret key component 1:", topGame.name.split(" ")[0]);
console.log("Secret key component 2:", secondTopGame.name.split(" ")[0]);